...
/*   Updated: 2024/09/10 19:11:03 by gigardin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		{
// 			*token = (*token)->next; // Pula o token de redirecionamento
// 			if (*token != NULL)
// 				*token = (*token)->next; // Pula o token do arquivo
// 		}
// 		else
// 		{
...
// 			*token = (*token)->next;
// 			if (*token != NULL)
// 				add_redir(&new_cmd->redirs, type, (*token)->str);
// 		}
// 		*token = (*token)->next;
// 	}
